...
const Sunrise = createLucideIcon("sunrise", __iconNode$1);
const __iconNode = [
...
const ALL_COUNTRIES = countriesFC.features;
function AnimatedGlobe({
  ...
  const [rotation, setRotation] = reactExports.useState([-lon, -lat * 0.35]);
  const raf = reactExports.useRef(null);
  const last = reactExports.useRef(0);
  const target = reactExports.useRef([-lon, -lat * 0.35]);
  ...
  reactExports.useEffect(() => {
    ...
    const tick = (t) => {
      const dt = (t - last.current) / 1e3;
      last.current = t;
      setRotation((r) => {
        const [tλ, tφ] = target.current;
        const lerp = Math.min(1, dt * 2.4);
        const nλ = r[0] + (tλ - r[0]) * lerp + dt * 4;
  ...
  const projection2 = reactExports.useMemo(
    () => geoOrthographic().scale(size / 2 - 4).translate([size / 2, size / 2]).rotate([rotation[0], rotation[1], 0]).clipAngle(90),
    [rotation, size]
  );
  const path = reactExports.useMemo(() => geoPath(projection2), [projection2]);
  const matchName = countryCode ? NAME_BY_ISO2[countryCode] ?? countryName : countryName;
  const selectedFeature = reactExports.useMemo(
    () => matchName ? ALL_COUNTRIES.find((f) => f.properties.name === matchName) : void 0,
    [matchName]
  );
  const graticule2 = reactExports.useMemo(() => path(graticule10()), [path]);
  const sphereD = `M ${size / 2 - (size / 2 - 4)} ${size / 2} a ${size / 2 - 4} ${size / 2 - 4} 0 1 0 ${size - 8} 0 a ${size / 2 - 4} ${size / 2 - 4} 0 1 0 -${size - 8} 0`;
  const markerXY = projection2([lon, lat]);
  const markerHaloD = reactExports.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: size, height: size }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: `0 0 ${size} ${size}`, width: size, height: size, "aria-hidden": true, className: "overflow-visible", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "globe-fill", cx: "35%", cy: "35%", r: "75%", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "color-mix(in oklab, var(--primary) 30%, transparent)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "60%", stopColor: "color-mix(in oklab, var(--primary) 10%, transparent)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "color-mix(in oklab, var(--primary) 4%, transparent)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: "globe-glow", cx: "50%", cy: "50%", r: "50%", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "80%", stopColor: "color-mix(in oklab, var(--primary) 0%, transparent)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "color-mix(in oklab, var(--primary) 28%, transparent)" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: size / 2, cy: size / 2, r: size / 2 - 4 + 6, fill: "url(#globe-glow)" }),
      ...
      graticule2 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          d: graticule2,
          fill: "none",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "g",
        {
          ...
          strokeWidth: 0.4,
          children: ALL_COUNTRIES.map((f, i) => {
            const d = path(f);
            if (!d) return null;
            return /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d }, i);
          })
        }
      ),
      selectedFeature && (() => {
      ...
      markerHaloD && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          d: markerHaloD,
          fill: "none",
      ...
      markerXY && /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("circle", { cx: markerXY[0], cy: markerXY[1], r: 9, fill: "color-mix(in oklab, var(--saffron) 45%, transparent)", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("animate", { attributeName: "r", values: "5;13;5", dur: "2.2s", repeatCount: "indefinite" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("animate", { attributeName: "opacity", values: "0.8;0;0.8", dur: "2.2s", repeatCount: "indefinite" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
    ...
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-x-0 bottom-2 text-center text-[10px] uppercase tracking-[0.25em] text-muted-foreground", children: label })
  ] });
}
export {
  AnimatedGlobe as A,
