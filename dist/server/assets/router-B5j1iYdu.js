...
const appCss = "/assets/styles-D767Cv5-.css";
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 border-b border-border/50 bg-background/70 backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-14 max-w-6xl items-center justify-between px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 font-display font-bold tracking-tight", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg", children: [
        "worldClockly",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: ".com" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-6 text-sm text-muted-foreground md:flex", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", activeOptions: { exact: true }, activeProps: { className: "text-foreground" }, className: "hover:text-foreground transition-colors", children: "Clock" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/difference", activeProps: { className: "text-foreground" }, className: "hover:text-foreground transition-colors", children: "Time Difference" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/countdown", activeProps: { className: "text-foreground" }, className: "hover:text-foreground transition-colors", children: "Countdown" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/holidays", activeProps: { className: "text-foreground" }, className: "hover:text-foreground transition-colors", children: "Holidays" })
    ] }),
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-24 border-t border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-4 py-10 text-sm text-muted-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start justify-between gap-6 md:flex-row md:items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 font-display font-bold text-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock3, { className: "h-4 w-4 text-primary" }),
          "worldClockly",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: ".com" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-md", children: "India-first global time platform. Atomic-accurate clocks, world time, holidays and countdowns." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "hover:text-foreground", children: "Clock" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/difference", className: "hover:text-foreground", children: "Difference" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/countdown", className: "hover:text-foreground", children: "Countdown" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/holidays", className: "hover:text-foreground", children: "Holidays" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 border-t border-border/50 pt-6 text-xs", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " worldClockly.com — Precision time for India and the world."
    ] })
  ] }) });
}
...
const Route$7 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "worldClockly.com" },
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col bg-background text-foreground", children: [
...
const CITIES = [
  ...
  { slug: "beijing", city: "Beijing", country: "China", countryCode: "CN", tz: "Asia/Shanghai", flag: "🇨🇳", lat: 39.9042, lon: 116.4074, population: 215e5, about: "Capital of China and major cultural center." },
  { slug: "guangzhou", city: "Guangzhou", country: "China", countryCode: "CN", tz: "Asia/Shanghai", flag: "🇨🇳", lat: 23.1291, lon: 113.2644, population: 188e5 },
  { slug: "shenzhen", city: "Shenzhen", country: "China", countryCode: "CN", tz: "Asia/Shanghai", flag: "🇨🇳", lat: 22.5431, lon: 114.0579, population: 176e5 },
  { slug: "chengdu", city: "Chengdu", country: "China", countryCode: "CN", tz: "Asia/Shanghai", flag: "🇨🇳", lat: 30.5728, lon: 104.0668, population: 163e5 },
  { slug: "wuhan", city: "Wuhan", country: "China", countryCode: "CN", tz: "Asia/Shanghai", flag: "🇨🇳", lat: 30.5928, lon: 114.3055, population: 123e5 },
  { slug: "osaka", city: "Osaka", country: "Japan", countryCode: "JP", tz: "Asia/Tokyo", flag: "🇯🇵", lat: 34.6937, lon: 135.5023, population: 192e5 },
  { slug: "nagoya", city: "Nagoya", country: "Japan", countryCode: "JP", tz: "Asia/Tokyo", flag: "🇯🇵", lat: 35.1815, lon: 136.9066, population: 92e5 },
  { slug: "fukuoka", city: "Fukuoka", country: "Japan", countryCode: "JP", tz: "Asia/Tokyo", flag: "🇯🇵", lat: 33.5904, lon: 130.4017, population: 26e5 },
  { slug: "delhi", city: "Delhi", country: "India", countryCode: "IN", tz: "Asia/Kolkata", flag: "🇮🇳", lat: 28.7041, lon: 77.1025, population: 33e6 },
  { slug: "pune", city: "Pune", country: "India", countryCode: "IN", tz: "Asia/Kolkata", flag: "🇮🇳", lat: 18.5204, lon: 73.8567, population: 75e5, about: "Major IT and education hub in western India." },
  { slug: "ahmedabad", city: "Ahmedabad", country: "India", countryCode: "IN", tz: "Asia/Kolkata", flag: "🇮🇳", lat: 23.0225, lon: 72.5714, population: 85e5 },
  { slug: "surat", city: "Surat", country: "India", countryCode: "IN", tz: "Asia/Kolkata", flag: "🇮🇳", lat: 21.1702, lon: 72.8311, population: 7e6 },
  { slug: "jaipur", city: "Jaipur", country: "India", countryCode: "IN", tz: "Asia/Kolkata", flag: "🇮🇳", lat: 26.9124, lon: 75.7873, population: 42e5 },
  { slug: "lahore", city: "Lahore", country: "Pakistan", countryCode: "PK", tz: "Asia/Karachi", flag: "🇵🇰", lat: 31.5204, lon: 74.3587, population: 13e6 },
  { slug: "islamabad", city: "Islamabad", country: "Pakistan", countryCode: "PK", tz: "Asia/Karachi", flag: "🇵🇰", lat: 33.6844, lon: 73.0479, population: 12e5 },
  { slug: "jakarta", city: "Jakarta", country: "Indonesia", countryCode: "ID", tz: "Asia/Jakarta", flag: "🇮🇩", lat: -6.2088, lon: 106.8456, population: 107e5 },
  { slug: "surabaya", city: "Surabaya", country: "Indonesia", countryCode: "ID", tz: "Asia/Jakarta", flag: "🇮🇩", lat: -7.2575, lon: 112.7521, population: 3e6 },
  { slug: "manila", city: "Manila", country: "Philippines", countryCode: "PH", tz: "Asia/Manila", flag: "🇵🇭", lat: 14.5995, lon: 120.9842, population: 139e5 },
  { slug: "cebu", city: "Cebu", country: "Philippines", countryCode: "PH", tz: "Asia/Manila", flag: "🇵🇭", lat: 10.3157, lon: 123.8854, population: 1e6 },
  { slug: "hanoi", city: "Hanoi", country: "Vietnam", countryCode: "VN", tz: "Asia/Ho_Chi_Minh", flag: "🇻🇳", lat: 21.0278, lon: 105.8342, population: 85e5 },
  { slug: "ho-chi-minh-city", city: "Ho Chi Minh City", country: "Vietnam", countryCode: "VN", tz: "Asia/Ho_Chi_Minh", flag: "🇻🇳", lat: 10.8231, lon: 106.6297, population: 93e5 },
  { slug: "kuala-lumpur", city: "Kuala Lumpur", country: "Malaysia", countryCode: "MY", tz: "Asia/Kuala_Lumpur", flag: "🇲🇾", lat: 3.139, lon: 101.6869, population: 8e6 },
  { slug: "penang", city: "Penang", country: "Malaysia", countryCode: "MY", tz: "Asia/Kuala_Lumpur", flag: "🇲🇾", lat: 5.4164, lon: 100.3327, population: 18e5 },
  ...
  { slug: "abu-dhabi", city: "Abu Dhabi", country: "UAE", countryCode: "AE", tz: "Asia/Dubai", flag: "🇦🇪", lat: 24.4539, lon: 54.3773, population: 15e5 },
  { slug: "tehran", city: "Tehran", country: "Iran", countryCode: "IR", tz: "Asia/Tehran", flag: "🇮🇷", lat: 35.6892, lon: 51.389, population: 95e5 },
  { slug: "baghdad", city: "Baghdad", country: "Iraq", countryCode: "IQ", tz: "Asia/Baghdad", flag: "🇮🇶", lat: 33.3152, lon: 44.3661, population: 87e5 },
  { slug: "nairobi", city: "Nairobi", country: "Kenya", countryCode: "KE", tz: "Africa/Nairobi", flag: "🇰🇪", lat: -1.2921, lon: 36.8219, population: 5e6 },
  { slug: "lagos", city: "Lagos", country: "Nigeria", countryCode: "NG", tz: "Africa/Lagos", flag: "🇳🇬", lat: 6.5244, lon: 3.3792, population: 15e6 },
  { slug: "casablanca", city: "Casablanca", country: "Morocco", countryCode: "MA", tz: "Africa/Casablanca", flag: "🇲🇦", lat: 33.5731, lon: -7.5898, population: 37e5 },
  { slug: "algiers", city: "Algiers", country: "Algeria", countryCode: "DZ", tz: "Africa/Algiers", flag: "🇩🇿", lat: 36.7538, lon: 3.0588, population: 35e5 },
  { slug: "rome", city: "Rome", country: "Italy", countryCode: "IT", tz: "Europe/Rome", flag: "🇮🇹", lat: 41.9028, lon: 12.4964, population: 43e5 },
  { slug: "madrid", city: "Madrid", country: "Spain", countryCode: "ES", tz: "Europe/Madrid", flag: "🇪🇸", lat: 40.4168, lon: -3.7038, population: 67e5 },
  { slug: "barcelona", city: "Barcelona", country: "Spain", countryCode: "ES", tz: "Europe/Madrid", flag: "🇪🇸", lat: 41.3851, lon: 2.1734, population: 56e5 },
  { slug: "amsterdam", city: "Amsterdam", country: "Netherlands", countryCode: "NL", tz: "Europe/Amsterdam", flag: "🇳🇱", lat: 52.3676, lon: 4.9041, population: 25e5 },
  { slug: "brussels", city: "Brussels", country: "Belgium", countryCode: "BE", tz: "Europe/Brussels", flag: "🇧🇪", lat: 50.8503, lon: 4.3517, population: 21e5 },
  { slug: "vienna", city: "Vienna", country: "Austria", countryCode: "AT", tz: "Europe/Vienna", flag: "🇦🇹", lat: 48.2082, lon: 16.3738, population: 2e6 },
  { slug: "zurich", city: "Zurich", country: "Switzerland", countryCode: "CH", tz: "Europe/Zurich", flag: "🇨🇭", lat: 47.3769, lon: 8.5417, population: 15e5 },
  { slug: "stockholm", city: "Stockholm", country: "Sweden", countryCode: "SE", tz: "Europe/Stockholm", flag: "🇸🇪", lat: 59.3293, lon: 18.0686, population: 17e5 },
  { slug: "oslo", city: "Oslo", country: "Norway", countryCode: "NO", tz: "Europe/Oslo", flag: "🇳🇴", lat: 59.9139, lon: 10.7522, population: 11e5 },
  { slug: "helsinki", city: "Helsinki", country: "Finland", countryCode: "FI", tz: "Europe/Helsinki", flag: "🇫🇮", lat: 60.1699, lon: 24.9384, population: 13e5 },
  { slug: "copenhagen", city: "Copenhagen", country: "Denmark", countryCode: "DK", tz: "Europe/Copenhagen", flag: "🇩🇰", lat: 55.6761, lon: 12.5683, population: 14e5 },
  { slug: "athens", city: "Athens", country: "Greece", countryCode: "GR", tz: "Europe/Athens", flag: "🇬🇷", lat: 37.9838, lon: 23.7275, population: 31e5 },
  { slug: "warsaw", city: "Warsaw", country: "Poland", countryCode: "PL", tz: "Europe/Warsaw", flag: "🇵🇱", lat: 52.2297, lon: 21.0122, population: 18e5 },
  { slug: "prague", city: "Prague", country: "Czech Republic", countryCode: "CZ", tz: "Europe/Prague", flag: "🇨🇿", lat: 50.0755, lon: 14.4378, population: 14e5 },
  { slug: "budapest", city: "Budapest", country: "Hungary", countryCode: "HU", tz: "Europe/Budapest", flag: "🇭🇺", lat: 47.4979, lon: 19.0402, population: 17e5 },
  { slug: "lisbon", city: "Lisbon", country: "Portugal", countryCode: "PT", tz: "Europe/Lisbon", flag: "🇵🇹", lat: 38.7223, lon: -9.1393, population: 29e5 },
  { slug: "dublin", city: "Dublin", country: "Ireland", countryCode: "IE", tz: "Europe/Dublin", flag: "🇮🇪", lat: 53.3498, lon: -6.2603, population: 14e5 },
  { slug: "buenos-aires", city: "Buenos Aires", country: "Argentina", countryCode: "AR", tz: "America/Argentina/Buenos_Aires", flag: "🇦🇷", lat: -34.6037, lon: -58.3816, population: 153e5 },
  { slug: "lima", city: "Lima", country: "Peru", countryCode: "PE", tz: "America/Lima", flag: "🇵🇪", lat: -12.0464, lon: -77.0428, population: 11e6 },
  { slug: "bogota", city: "Bogotá", country: "Colombia", countryCode: "CO", tz: "America/Bogota", flag: "🇨🇴", lat: 4.711, lon: -74.0721, population: 11e6 },
  { slug: "santiago", city: "Santiago", country: "Chile", countryCode: "CL", tz: "America/Santiago", flag: "🇨🇱", lat: -33.4489, lon: -70.6693, population: 62e5 },
  { slug: "rio-de-janeiro", city: "Rio de Janeiro", country: "Brazil", countryCode: "BR", tz: "America/Sao_Paulo", flag: "🇧🇷", lat: -22.9068, lon: -43.1729, population: 135e5 },
  { slug: "miami", city: "Miami", country: "USA", countryCode: "US", tz: "America/New_York", flag: "🇺🇸", lat: 25.7617, lon: -80.1918, population: 62e5 },
  { slug: "houston", city: "Houston", country: "USA", countryCode: "US", tz: "America/Chicago", flag: "🇺🇸", lat: 29.7604, lon: -95.3698, population: 71e5 },
  { slug: "san-francisco", city: "San Francisco", country: "USA", countryCode: "US", tz: "America/Los_Angeles", flag: "🇺🇸", lat: 37.7749, lon: -122.4194, population: 47e5 },
  { slug: "toronto", city: "Toronto", country: "Canada", countryCode: "CA", tz: "America/Toronto", flag: "🇨🇦", lat: 43.6532, lon: -79.3832, population: 293e4 },
  { slug: "montreal", city: "Montreal", country: "Canada", countryCode: "CA", tz: "America/Toronto", flag: "🇨🇦", lat: 45.5017, lon: -73.5673, population: 178e4 },
  { slug: "washington-dc", city: "Washington DC", country: "USA", countryCode: "US", tz: "America/New_York", flag: "🇺🇸", lat: 38.9072, lon: -77.0369, population: 63e5 },
  { slug: "boston", city: "Boston", country: "USA", countryCode: "US", tz: "America/New_York", flag: "🇺🇸", lat: 42.3601, lon: -71.0589, population: 48e5 }
];
...
const $$splitComponentImporter$5 = () => import("./holidays-B_YnUbVF.js");
...
const $$splitComponentImporter$4 = () => import("./difference-DQyPg0Ye.js");
const Route$4 = createFileRoute("/difference")({
  ...
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Time Difference Calculator — worldClockly.com"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$3 = () => import("./countdown-CZCKP_oG.js");
const Route$3 = createFileRoute("/countdown")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Countdown to any event, exam, IPL match or world cup. Pick a country to load its public holidays, add your own custom events, and use the built-in Pomodoro focus timer."
    }, {
      property: "og:title",
      content: "Countdowns & Pomodoro — worldClockly.com"
    }, {
      property: "og:description",
      content: "Live countdowns by country, custom events, and a beautiful Pomodoro timer."
    }],
    links: [{
      rel: "canonical",
      href: "/countdown"
...
const $$splitComponentImporter$2 = () => import("./index-zAitaTgR.js");
const Route$2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Atomic-accurate Indian Standard Time, world clocks, time zones, sunrise/sunset and countdowns. India's most trusted time utility."
    }, {
      property: "og:title",
      content: "worldClockly.com — Exact Time Now"
    }, {
      property: "og:description",
...
const $$splitNotFoundComponentImporter$1 = () => import("./countries._country-Bua0yBNg.js");
const $$splitComponentImporter$1 = () => import("./countries._country-Do8k8j5u.js");
        ...
        children: JSON.stringify({
          ...
          "@graph": [{
            ...
            mainEntity: [{
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: `worldClockly.com uses the IANA time zone database, so any DST transitions for ${c.name} are reflected automatically in the clocks above.`
              }
            }]
          }]
        })
...
const $$splitNotFoundComponentImporter = () => import("./cities._city-C6DVD4rO.js");
const $$splitComponentImporter = () => import("./cities._city-B1i-DtXP.js");
const Route2 = createFileRoute("/cities/$city")({
  loader: ({
    params
  }) => {
        ...
        children: JSON.stringify({
          ...
          "@graph": [{
            ...
            mainEntity: [{
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: `${c.city} uses the ${c.tz} time zone. worldClockly.com displays the exact local time, synchronized with your device clock.`
              }
            }, {
              "@type": "Question",
...
const CitiesCityRoute = Route2.update({
  id: "/cities/$city",
  path: "/cities/$city",
  getParentRoute: () => Route$7
});
...
export {
  ...
  getUniqueTimezonesInCountry as d,
